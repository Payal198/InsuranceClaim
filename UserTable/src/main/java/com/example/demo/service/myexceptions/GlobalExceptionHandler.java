package com.example.demo.service.myexceptions;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(NullPointerException.class) // You can replace it with your custom exception
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ExceptionHandler(IllegalArgumentException.class) // You can replace it with your custom exception
